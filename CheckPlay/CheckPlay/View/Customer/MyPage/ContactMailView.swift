...
struct ContactMailView: UIViewControllerRepresentable {
  ...
  func makeUIViewController(context: UIViewControllerRepresentableContext<ContactMailView>) -> MFMailComposeViewController {
  ...
  func updateUIViewController(_ uiViewController: MFMailComposeViewController,
                              context: UIViewControllerRepresentableContext<ContactMailView>) {
  }
